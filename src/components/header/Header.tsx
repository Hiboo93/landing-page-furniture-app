...
//px-5 peut etre a supprimer  sur la ligne 10 et 22
    ...
    <div className="w-full md:h-[105vh] h-screen bg-cover relative bg-center md:px-[80px] py-[40px]" style={{backgroundImage: `url(${bg})`}}>
      <div className="w-full flex items-center justify-between px-5">
        ...
        <div className="hidden md:flex items-center gap-[62px]">
          {
            LINKS.map((items) => (
              <a key={items.link} href={items.href} className="text-white no-underline font-medium text-[18px] transition-all duration-300 hover:text-[#11e5c2]">{items.link}</a>
            ))
          }
        </div>
      ...
      <div className="w-full flex flex-col gap-5 items-center justify-center md:mt-[100px] mt-5">
        ...
        <p className="text-white md:text-[24px] text-[18px] font-[200] max-w-[600px] text-center">
          Turn your room with panto a lot more minimalist and modern with ease and speed
        </p>
      </div>
